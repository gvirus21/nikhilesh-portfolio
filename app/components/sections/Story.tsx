...
export const Story = () => {
  return (
    <div className="pt-32 lg:pt-40">
      <Copy delay={0.1}>
        <h1 className="text-center text-7xl md:text-7xl lg:text-7xl 2xl:text-9xl tracking-[-4px] md:tracking-[-2px] leading-28 2xl:leading-36">
          My<span className="tracking-[-10px]"> </span>Story
        </h1>
      </Copy>

      <div className="flex flex-col text-justify lg:text-justify mx-auto items-center mt-20 lg:mt-20 text-xl md:text-xl lg:text-2xl xl:text-xl 2xl:text-3xl font-light leading-relaxed px-2">
